	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title text-dark">SELECT SEO</h4> <button onclick="hideModal('getSEOModal')" type="button" class="close" data-dismiss="modal">&times;</button>
			</div>
      ...
      <form id="getSEOForm" class="form-horizontal">
			...
			<div class="modal-footer">
				...
				<button type="button" onclick="hideModal('getSEOModal')" class="btn btn-dark">Close</button>
			</div>
      </form>
		</div>
