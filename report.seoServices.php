...
<div class="col-lg-12 ">
		<div class="card ">
			<div class="card-body">
				<h5 class="card-title">SEO SERVICE REPORT <button data-toggle="modal" onclick="openModal()" type="button" class="btn btn-light btn-round btn-sm px-5 pull-right">SELECT SEO</button></h5>
				<div class="table-responsive">
				<table id="myServicesTable" class="table table-hover">
						<thead>
							<tr>
								<th scope="col">#</th>
                <th scope="col">SEO</th>
      ...
      <form id="getSEOForm" class="form-horizontal">
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<select name="seoId" class="form-control form-control-rounded" id="">
              <?php
...
$(document).ready(function()
{
  ...
  $("#getSEOForm").on('submit',(function(e) {
			   e.preventDefault();
			   $.ajax({
					   url: "ajax.report.getServices.php",
					   type: "POST",
					   ...
					   success: function(r)
						  {
                makeTableData('myServicesTable',r)
